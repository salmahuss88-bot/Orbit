            ...
            <table className="w-full text-center border-collapse min-w-[800px] md:min-w-full">
              ...
              <thead className="bg-white sticky top-0 z-10 text-[#515151] text-[10px] tracking-widest uppercase font-sans">
                <tr>
                  ...
                  <th className="px-4 md:px-8 py-4 text-right pr-6 md:pr-12 font-bold whitespace-nowrap">Action</th>
                </tr>
              </thead>
              ...
              <tbody className="text-[13px] font-thin divide-y divide-[#D0D0D0]">
                {data.map((row, rowIndex) => (
                  <tr key={rowIndex} className="hover:bg-gray-50/30 transition-colors">
                    ...
                    <td className="px-4 py-4 text-right pr-6 md:pr-12">
                      <button 
                        onClick={() => onViewMore && onViewMore(row)}
                        className="text-[#2485C1] font-normal hover:underline text-[12px] md:text-[13px] whitespace-nowrap"
                      >
                        View more
                      </button>
                    </td>
